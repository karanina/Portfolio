...
namespace PointOfSale.Product
{
    public static class ProductSizeRules
    {
        ...
        )
        {
            ...
            {
                case SizeMeasurementType.Cm:
                    if (
                        !UnitOfMeasurementProductTypeMap[SizeMeasurementType.Cm]
                    ...
                    break;
                case SizeMeasurementType.Mm:
                    if (
                        !UnitOfMeasurementProductTypeMap[SizeMeasurementType.Mm]
                            .Contains(productType)
                    )
                    {
                        throw new ArgumentException(
                            $"{size}mm is an invalid size for {productType}."
                        );
                    }
                    ValidateMmSize(productType, size);
                    break;
        ...
        public static void ValidateMmSize(ProductType productType, string size)
        {
            switch (productType)
            {
