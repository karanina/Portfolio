...
namespace PointOfSale.Tests
{
    ...
    {
        [Fact]
        public void Constructor_Success_CreateSaleItemWithAllParameters()
        {
            // Arrange & Act
            SaleItem item = new SaleItem("B0001-65mm-9Y", "5mm wide bangle", 199.99m, 2, 10, false);
        ...
        [Fact]
        public void Constructor_Success_CreateSaleItemWithOnlyRequiredParameters()
        {
            // Arrange & Act
            SaleItem item = new SaleItem("B0001-65mm-9Y", "5mm wide bangle", 199.99m);
        ...
        [Fact]
        public void Constructor_Success_CreateSaleItemWithRequiredParametersAndQuantity()
        {
            // Arrange & Act
            SaleItem item = new SaleItem("B0001-65mm-9Y", "5mm wide bangle", 199.99m, quantity: 5);
        ...
        [Fact]
        public void Constructor_Success_CreateSaleItemWithRequiredParametersAndManualDiscountRate()
        {
            // Arrange & Act
        ...
        [Fact]
        public void Constructor_Success_CreateSaleItemWithRequiredParametersAndIsManualUnitPrice()
        {
            // Arrange & Act
            SaleItem item = new SaleItem(
                "B0001-65mm-9Y",
        ...
        public void Constructor_ThrowsException_WhenSellPriceIsNegative()
        {
            // Arrange, Act & Assert
            var exception = Assert.Throws<ArgumentException>(
                () => new SaleItem("B0001-65-9Y", "5mm wide bangle", -00.01m)
            );
        ...
        public void Constructor_ThrowsException_WhenQuantityIsZero()
        {
            // Arrange, Act & Assert
            var exception = Assert.Throws<ArgumentException>(
                () => new SaleItem("B0001-65-9Y", "5mm wide bangle", 199.99m, quantity: 0)
            );
        ...
        public void Constructor_ThrowsException_WhenQuantityIsNegative()
        {
            // Arrange, Act & Assert
            var exception = Assert.Throws<ArgumentException>(
                () => new SaleItem("B0001-65-9Y", "5mm wide bangle", 199.99m, quantity: -1)
            );
        ...
        {
            // Arrange
            SaleItem item = new SaleItem("B0001-65mm-9Y", "5mm wide bangle", 199.99m, quantity: 2);
