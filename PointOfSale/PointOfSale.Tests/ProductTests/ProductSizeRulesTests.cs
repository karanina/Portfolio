...
namespace PointOfSale.Tests.Product
{
    public class ProductSizeRulesTests
    {
        [Theory]
        [InlineData(SizeMeasurementType.Cm, ProductType.Necklace, "45")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Chain, "55")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Bracelet, "15")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Anklet, "22")]
        public void ValidateSize_Success_WithCmMeasurementTypeAndValidProductTypeAndSize(
        ...
        [Theory]
        [InlineData(SizeMeasurementType.Cm, ProductType.Necklace, "15")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Chain, "10")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Bracelet, "55")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Anklet, "45")]
        public void ValidateSize_ThrowsException_WithCmMeasurementTypeAndValidProductTypeAndInvalidSize(
            SizeMeasurementType sizeMeasurementType,
            ProductType productType,
            string size
        )
        {
            ...
            // Assert
            Assert.Equal($"{size}cm is an invalid size for {productType}.", exception.Message);
        }

        [Theory]
        [InlineData(SizeMeasurementType.Cm, ProductType.Bangle, "45")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Brooch, "55")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Charm, "15")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Cufflink, "22")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Earring, "17")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Pendant, "60")]
        [InlineData(SizeMeasurementType.Cm, ProductType.Ring, "65")]
        public void ValidateSize_ThrowsException_WithCmMeasurementTypeAndInvalidProductTypeAndSize(
            SizeMeasurementType sizeMeasurementType,
            ProductType productType,
            string size
        )
        ...
        [Theory]
        [InlineData(SizeMeasurementType.Mm, ProductType.Bangle, "65")]
        public void ValidateSize_Success_WithMmMeasurementTypeAndValidProductTypeAndSize(
            SizeMeasurementType sizeMeasurementType,
            ProductType productType,
            string size
        )
        ...
        [Theory]
        [InlineData(SizeMeasurementType.Mm, ProductType.Anklet, "15")]
        [InlineData(SizeMeasurementType.Mm, ProductType.Bracelet, "15")]
        [InlineData(SizeMeasurementType.Mm, ProductType.Brooch, "15")]
        [InlineData(SizeMeasurementType.Mm, ProductType.Chain, "15")]
        [InlineData(SizeMeasurementType.Mm, ProductType.Charm, "15")]
        [InlineData(SizeMeasurementType.Mm, ProductType.Cufflink, "15")]
        [InlineData(SizeMeasurementType.Mm, ProductType.Earring, "15")]
        [InlineData(SizeMeasurementType.Mm, ProductType.Necklace, "15")]
        [InlineData(SizeMeasurementType.Mm, ProductType.Pendant, "15")]
        [InlineData(SizeMeasurementType.Mm, ProductType.Ring, "15")]
        public void ValidateSize_ThrowsException_WithMmMeasurementTypeAndInvalidProductTypeAndSize(
            SizeMeasurementType sizeMeasurementType,
            ProductType productType,
            string size
        )
        {
            ...
            // Assert
            Assert.Equal($"{size}mm is an invalid size for {productType}.", exception.Message);
        }

        [Theory]
        [InlineData(SizeMeasurementType.Mm, ProductType.Bangle, "15")]
        public void ValidateSize_ThrowsException_WithMmMeasurementTypeAndValidProductTypeAndInvalidSize(
            SizeMeasurementType sizeMeasurementType,
            ProductType productType,
            string size
        )
