...
namespace PointOfSale.Tests.Domain.SalesTests
{
    public class SaleCalculatorTests
    {
        ...
        public void CalculateLineTotal_MultipliesByQuantity()
        {
            ...
            // Act
            var total = salecalculator.CalculateLineTotal(sale, item);
        ...
        public void CalculateLineTotal_AppliesDiscountRate()
        {
            ...
            // Act
            var actual = salecalculator.CalculateLineTotal(sale, item);
        ...
        public void CalculateLineTotal_ManualItemDiscountOverridesCustomerDiscount()
        {
            ...
            // Act
            var actual = salecalculator.CalculateLineTotal(
                sale,
                new SaleItemView(
                    item.ProductId,
                    item.Description,
        ...
        public void CalculateLineTotal_ManualUnitPriceDoesNotGetDiscounted()
        {
            ...
            // Act
            var total = salecalculator.CalculateLineTotal(
                sale,
                new SaleItemView(
                    item.ProductId,
                    item.Description,
        ...
        public void CalculateGST_FromInclusiveSubtotal_CalculatesGSTAtNominatedPercentage()
        {
            ...
            // Act
            decimal actual = salecalculator.CalculateGST(sale, gstRate);
