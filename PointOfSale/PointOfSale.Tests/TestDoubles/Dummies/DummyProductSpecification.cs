...
namespace PointOfSale.Tests.TestDoubles.Dummies
{
    ...
    public class DummyProductSpecification : ProductSpecification
    {
        public DummyProductSpecification(string productId, string name, decimal price)
